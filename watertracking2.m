function [pairs,average_ratio,positions,intensities,res]=dna_particle_tracking(imagestack,radrange,maxmove,boxsize)
...
% Now that we have healed tracks we can find intensities at each point.
