function pos = pretrack(rawimg, bnoise, bsize, thresh, boxsize, searchsize, cutoff)
...
for i=1:total_time
    ...
    clear gt bw bp gt2 bw2 dist lt summary data;
    ...
    %dist=(1/norm)*bwdist(1-bw2);    % Normalized distance transform of inverse image.
