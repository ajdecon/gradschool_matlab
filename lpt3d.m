function final_result = lpt3d(image0, threshold, boxsize)

% Adam DeConinck, 28 July 2009.
%
% This version is a 3D-ized version of local_percent_threshold.m.
% IT TAKES A LONG LONG LONG LONG TIME TO RUN!
%
...
for x=1:Nx
    for y=1:Ny
        ...
        if ( (y>boxsize) && (y<(Ny-boxsize)) && (x>boxsize) && (x<(Nx-boxsize)) && (z>boxsize) && (z<(Nz-boxsize)) )
